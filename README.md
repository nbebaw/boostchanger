...
### Download
  ...
  OS| Release Link |
--- | --- |
Debian | [AppImage](https://github.com/nbebaw/boostchanger/releases/download/v4.3.3/boostchanger-4.3.3.AppImage) :cd: | 
Ubuntu | [AppImage](https://github.com/nbebaw/boostchanger/releases/download/v4.3.3/boostchanger-4.3.3.AppImage) :cd: | 
Fedora | [AppImage](https://github.com/nbebaw/boostchanger/releases/download/v4.3.3/boostchanger-4.3.3.AppImage) :cd: | 
Redhat | [AppImage](https://github.com/nbebaw/boostchanger/releases/download/v4.3.3/boostchanger-4.3.3.AppImage) :cd: | 
Solus | [AppImage](https://github.com/nbebaw/boostchanger/releases/download/v4.3.3/boostchanger-4.3.3.AppImage) :cd: | 
OpenSUSE | [AppImage](https://github.com/nbebaw/boostchanger/releases/download/v4.3.3/boostchanger-4.3.3.AppImage) :cd: | 
...
```bash
# Download the app
wget https://github.com/nbebaw/boostchanger/releases/download/v4.3.3/boostchanger-4.3.3.AppImage

# Make the app executable 
chmod +x boostchanger-4.3.3.AppImage

# Run the app
./boostchanger-4.3.3.AppImage
```
